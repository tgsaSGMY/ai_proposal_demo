<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
    ...
    <!-- 第三层： 用户输入 + 辅助输入框 -->
  <div class="mb-4 sm:mb-6 space-y-4 sm:space-y-6 flex-grow flex flex-col min-h-0">
      <!-- 主想法输入框 -->
      <div class="flex-shrink-0">
        <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-1 sm:mb-2 gap-1 sm:gap-0">
      ...
      >
        <div class="p-3 sm:p-4 bg-indigo-50 border border-indigo-200 rounded-lg mb-4 sm:mb-6">
        ...
        >
          <div class="group flex items-center justify-between border-b pb-1 sm:pb-2">
            <h4 class="text-sm sm:text-md font-semibold text-gray-800 transition-colors">
              {{ group.sectionName }}
            </h4>
          </div>
        ...
        >
          <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl p-4 sm:p-6">
            <h3 class="text-base sm:text-lg font-bold mb-2 sm:mb-4">AI 分析重點</h3>
