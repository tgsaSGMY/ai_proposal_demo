 ...
 * 子字段定義清單
 * 定義所有可用的子字段類型及其標籤
 * 目前只啟用 "reply"，其他類型已保留供未來擴展
 */
export const DYNAMIC_SUB_FIELD_DEFINITIONS: DynamicSubFieldDefinition[] = [
  { key: "reply", label: "回覆" },
  //   { key: "primary_issue", label: "第一層(主要問題)" },
  //   { key: "secondary_issue", label: "第二層(該問題子項)" },
  //   { key: "tertiary_issue", label: "第三層(該問題孫項目)(關鍵know-how)" },
  //   { key: "acceptance", label: "驗收方式或備註" },
];
...
> = {
  ...
  //       計畫暫定名稱: {
  //         title: "1.計畫暫定名稱",
  //         description: "如何一句話說明這個計畫關鍵",
  //       },
  //       補助類別: {
  //         title: "2.送哪一個補助類別",
  //         description:
  //           "(SBIR?CITD?其他?) (是機械、電子、資通、文創、民生化工、服務還是?)",
  //       },
  //       計畫摘要: {
  //         title: "3.計畫摘要(最後整理)",
  //         description: "",
  ...
  "二、研發動機": {
    ...
    properties: {
      ...
      市場規模: {
        title: "2.技術或服務的市場規模?",
        description: "(例如: 量販-->大盤商-->小盤商-->)直接對消費者",
      },
    },
  },
  "三、解決辦法": {
    ...
    properties: {
      解決方式: {
        title: "1.具體說明可以解決的方式",
        description:
          "情境說明將如何進行(須符合該計畫精神,比如研發產品、服務模式創新等)",
      },
      關鍵技術: {
        title: "2.關鍵技術為何",
        description:
  ...
  "四、創新性分析": {
    ...
    properties: {
      ...
      計畫改善後說明: {
        title: "2.技術或服務的創新性?計畫改善後說明",
        description: "(設備研發類型需含具體設備做動流程)",
      },
    },
  },
  "五、驗收方式": {
  ...
  "六、競爭力分析": {
    ...
    properties: {
      競爭者介紹: {
        ...
        description: "廠商認為的競爭對手為誰?",
      },
      差異性: {
        title: "2.這些競爭者與本計畫產品運作的差異性在哪?",
        description: "憑什麼比對手吸引客戶購買?",
      },
      優勢: {
        title: "3.價格/產品/規格品質/技術優勢?",
        description:
          "(1)價格更便宜?\n(2)使用方式更簡易? 如何量化?\n(3)我們的品質如何證明比競爭對手好? (例:他廠牌都是用紙本,我們用數位)",
      },
    },
  },
  "七、計畫目標、效益": {
    ...
    properties: {
      查核點量化數值: {
        title: "1.具體查核點量化數值",
        description: "例如:每月可產出的項目數量、門市增加數量、產能提升數量",
      },
      佐證資料: {
        title: "2.可提供什麼佐證資料",
        description:
          "(1)規劃(例如規劃圖、功能規格、2D圖、3D圖)\n(2)開發(落實與執行項目有哪些)\n(3)測試(第三方驗證單位有哪些?)\n(4)其他(如:提升生產效率、降低人力時間、節能、環保、減碳、提高耐損、精度、良率、減少公差、即時監控雲端數據、統計資料庫安全性或降低風險...)",
      },
      量化效益: {
        title: "3.量化效益",
        description:
  ...
  "十、關鍵技術來源(委外)": {
    ...
    properties: {
      委外單位: {
        title: "1.委外單位",
        description:
          "(例:過去檢測、開發、設計、行銷跟誰合作,盡量討出廠商能配合的委外資源)",
      },
      合作單位負責項目: {
        title: "2.合作單位在該計畫中負責項目",
        description: "(例:規劃是誰?開發是誰?諮詢是誰?測試是誰?推廣試營運是誰?)",
      },
    },
  },
  "十一、智財分析": {
  ...
  "十二、經費": {
    ...
    properties: {
      ...
      委外單位費: {
        title: "2.委外單位費",
        description:
          "與本案合作之委外單位或是可協助開立收據和簽訂合作MOU的廠商\n業務說明編列方式及注意事項",
      },
      設備使用費: {
        title: "3.設備使用費",
        description:
          "要有財產編號、購入原價、數量、設備名稱、採購年月份。\n說明編列方式及注意事項",
      },
    },
  },
};
