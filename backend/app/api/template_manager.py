...
async def create_template_with_upload(
    ...
    grant_id: str = Form(...),
    name: str = Form(...),
    requires_paid_plan: str = Form(default="true"),
    submission_deadline: str = Form(default=""),
    subsidy_amount: str = Form(default=""),
    ...
    try:
        ...
        payload = {
            ...
            "grant_id": grant_id,
            "name": name,
            "requires_paid_plan": requires_paid_plan.lower() == "true",
            "submission_deadline": submission_deadline or None,
            "subsidy_amount": subsidy_amount or None,
...
async def update_template_with_upload(
    ...
    try:
        ...
        update_data = {
            "name": name,
            "requires_paid_plan": requires_paid_plan.lower() == "true",
            "submission_deadline": submission_deadline.strip(),
            "subsidy_amount": subsidy_amount.strip(),
